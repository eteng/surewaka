...
app.route('/api/v1/admin/dashboard', adminDashboardRoutes);
app.route('/api/v1/admin/customers', adminCustomerRoutes);
app.route('/api/v1/admin/drivers', adminDriverRoutes);
...
app.route('/api/v1/admin/carrier-parks', adminCarrierParksRoutes);
app.route('/api/v1/admin/carrier-routes', adminCarrierRoutesRoutes);
