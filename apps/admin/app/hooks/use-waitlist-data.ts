...
function buildQueryString(params: Partial<WaitlistQuery>): string {
...
export function useWaitlistData(params: Partial<WaitlistQuery>): UseWaitlistDataResult {
  ...
  // Serialize params to use as a stable dependency for useCallback/useEffect
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `${API_URL}/api/v1/admin/waitlist${queryString ? `?${queryString}` : ''}`;
